    ...
    <div id="targetmodal" data-target="brand"></div>
            <div class="row">
...
{{$method}}
                           ...
                           {!! Form::open(array('url' => route('brands.store'),'method'=>$method,'id'=>'Register')) !!}
  ...
  {{--                          <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                ...
                                {!! Form::text('brand', ($productId)?$productId->brand:null, array('placeholder' => '','class' => 'form-control')) !!}
                ...
                success:function(data) {
                    ...
                    if(data.errors) {
                        ...
                        if(data.errors.brand){
                            ...
                            $( '#name-error' ).html( data.errors.brand[0] );
                        }
